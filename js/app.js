...
const catalogo = [
  ...
  new Notebook(
    ...
    'https://images.unsplash.com/photo-1651241680016-cc9e407e7dc3?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'Apple M2', 8, 256, 13.6
  ),
  new Notebook(
  ...
  new Auricular(
    ...
    'https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?q=80&w=989&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'In-Ear', true, true
  ),
...
function crearTarjeta (producto) {
  ...
  precio.textContent = producto.precioFormateated;
  ...
  liStock.textContent = producto.estaDisponible ? `Stock: ${producto.stock} unidades` : 'Sin Stock';
